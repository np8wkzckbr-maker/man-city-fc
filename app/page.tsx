        ...
        <div className="max-w-6xl mx-auto px-8 py-28 md:py-36 grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-lg text-slate-300 leading-8 mb-10">
              When players love the game, they keep learning, keep competing, and keep growing. Every session is designed to build that love—and the skill, character, and confidence to go with it.
            </p>
